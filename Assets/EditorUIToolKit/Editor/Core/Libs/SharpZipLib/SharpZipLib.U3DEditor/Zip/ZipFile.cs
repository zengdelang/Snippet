...
using SharpZipLib.U3DEditor.Checksum;
using SharpZipLib.U3DEditor.Core;
using SharpZipLib.U3DEditor.Encryption;
using SharpZipLib.U3DEditor.Zip.Compression;
using SharpZipLib.U3DEditor.Zip.Compression.Streams;

#pragma warning disable 0219

namespace SharpZipLib.U3DEditor.Zip
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
        ...
        public void Add(string fileName, string entryName, bool useUnicodeText)
		{
			if (fileName == null) {
				throw new ArgumentNullException("fileName");
			}
			...
			CheckUpdating();
            var zipEntry = EntryFactory.MakeFileEntry(entryName, false);
